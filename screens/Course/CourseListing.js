...
const CourseListing = ({ navigation, route}) => {
    ...
    const filterModalSharedValue = useSharedValue(SIZES.height);
                ...
                ListHeaderComponent={
                    <View style={{
                        ...
                        <IconButton 
                            ...
                            onPress={(() => {
                                filterModalSharedValue.value = withTiming(0, { duration: 100 });
                                filterModalSharedValue2.value = withDelay(100, withTiming(0, { duration: 800 }))
                            })}
                        />
                    </View>
                }
    ...
    return (
        <View style={{
            ...
            {/* Filter Modal  */}
            <FilterModal filterModalSharedValue={filterModalSharedValue} filterModalSharedValue2={filterModalSharedValue2}/>
        </View>
    )
}
