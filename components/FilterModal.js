...
const ClassLevelOptions = ({ containerStyle, classLevel, isLastItem, isSelected, onPress}) => {
    return (
        <>
            <TouchableOpacity
                style={{
...
const FilterModal = ({ filterModalSharedValue, filterModalSharedValue2 }) => {
  ...
  const filterModalMainContainerAnimatedStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(
        filterModalSharedValue.value,
        [SIZES.height, 0],
        [0, 1]
      ),
      transform: [
        {
          translateY: filterModalSharedValue.value,
        },
      ],
    };
  });
  ...
  return (
    ...
    <Animated.View
      style={[
        ...
        filterModalMainContainerAnimatedStyle,
      ]}
    >
          ...
          >
            ...
            <TextButton
              ...
              onPress={() => {
                ...
                filterModalSharedValue.value = withDelay(
                  500,
