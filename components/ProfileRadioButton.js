...
let ProfileRadioButton = ({ appTheme, icon, label, isSelected, onPress }) => {
...
ProfileRadioButton = connect(mapStateToProps, mapDispatchToProps)(ProfileRadioButton)

export { ProfileRadioButton };
